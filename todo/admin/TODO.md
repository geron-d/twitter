...
- [x] (P2) [2026-01-27 12:00] #10: Обновить docker-compose.yml (опционально - рассмотреть удаление монтирования sql скриптов) — выполнено (удалено монтирование ./sql:/docker-entrypoint-initdb.d, добавлен комментарий о том, что миграции теперь управляются через Liquibase в admin-script-api)
  acceptance: "docker-compose.yml обновлен (или оставлен без изменений с обоснованием решения)"
- [x] (P2) [2026-01-27 12:05] #11: Обновить README (опционально) — выполнено (добавлен раздел "Управление миграциями базы данных (Liquibase)" с описанием структуры миграций, порядка выполнения, инструкциями по добавлению новых миграций, примерами операций и важными замечаниями; добавлено упоминание Liquibase в раздел зависимостей)
