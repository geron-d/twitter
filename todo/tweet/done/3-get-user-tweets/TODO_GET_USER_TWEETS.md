...
- [x] (P1) [2025-01-27 16:15] #12: OpenAPI аннотации для getUserTweets — Добавить полную OpenAPI документацию
  acceptance: "Полная OpenAPI документация с @Operation, @ApiResponses, @Parameter, @ExampleObject для всех сценариев"
  note: "Добавлен пример для пустого списка твитов в @ApiResponse для 200 OK. Теперь в документации два примера: 'Paginated Tweets' (с твитами) и 'Empty Tweets List' (пустой список). Используется массив examples = { @ExampleObject(...), @ExampleObject(...) } для нескольких примеров в одном статус-коде. Полная OpenAPI документация включает: @Operation с summary и description, @ApiResponses для 200 OK с двумя примерами, @Parameter для userId и pageable. Соответствует стандартам проекта (STANDART_SWAGGER.md)"

### Обновление README
- [x] (P2) [2025-01-27 16:30] #13: Обновление README.md — Добавить новый эндпоинт в документацию
  acceptance: "README обновлен: добавлен в таблицу эндпоинтов, детальное описание, примеры, обновлен раздел бизнес-логики"
  note: "Обновлен README.md: добавлена новая возможность 'Получение твитов пользователя с пагинацией' в раздел 'Основные возможности', добавлен эндпоинт GET /user/{userId} в таблицу эндпоинтов, добавлено детальное описание эндпоинта (раздел 4) с параметрами, валидацией, бизнес-правилами, примерами запросов/ответов (успешный ответ с твитами, пустой список, ошибки валидации), обновлен раздел 'Бизнес-логика' с описанием метода getUserTweets, добавлено бизнес-правило 'Получение твитов пользователя' с описанием пагинации и сортировки, добавлены примеры использования с curl командами. Соответствует стандартам проекта (STANDART_README.md)"

### Postman коллекции
- [x] (P2) [2025-01-27 16:45] #14: Обновление Postman коллекции — Добавить запрос для нового эндпоинта
...
- Ссылки на архитектуру:
  ...
  - [TWEET_API_COMMON_2.md](../0-base/TWEET_API_COMMON_2.md)
