...
- [x] (P2) [2025-01-21 11:45] #8: Документировать PasswordUtil — Добавить JavaDoc для утилитных методов  
  acceptance: "Все статические методы PasswordUtil имеют JavaDoc"
  note: "Добавлена полная JavaDoc для PasswordUtil: класс + 2 статических метода с детальным описанием криптографических алгоритмов, параметров безопасности и обработки исключений"

- [x] (P2) [2025-01-21 12:00] #9: Документировать PatchDtoFactory — Дополнить JavaDoc для метода createPatchDto  
  acceptance: "Метод createPatchDto имеет полную JavaDoc документацию"
  note: "Дополнена JavaDoc для метода createPatchDto: добавлено описание параметра userPatchDto, улучшено общее описание логики работы метода, расширено описание исключений"
