...
- [x] (P1) [2025-01-27] #7: Обновление JavaDoc для GenerateUsersAndTweetsServiceImpl — Обновить JavaDoc с описанием новых шагов 6-11.
  ...
  note: "Расширен JavaDoc с подробным описанием шагов 6-11: добавлены детали о логике выбора твитов (Collections.shuffle(), отслеживание использованных твитов), логике выбора пользователей (исключение автора твита), обработке ошибок (graceful handling, логирование, добавление в errors), edge cases (недостаточно твитов/пользователей), производительности (кэширование TweetResponseDto). Добавлен раздел с описанием стратегий для шагов 6-11."

### Документация
- [x] (P2) [2025-01-27] #8: Обновление README.md — Обновить README: описание новых шагов скрипта, новых методов Gateway, примеры использования.
  ...
  note: "Обновлен README.md: добавлены новые возможности (создание лайков и ретвитов) в раздел 'Основные возможности', добавлено описание шагов 6-11 в раздел 'Бизнес-логика', добавлено описание новых методов TweetsGateway (likeTweet, retweetTweet) и TweetsApiClient, обновлены примеры ответов с новыми полями totalLikesCreated и totalRetweetsCreated, добавлено описание процесса создания лайков и ретвитов в раздел 'Процесс выполнения скрипта', обновлена структура пакетов с новыми DTO."

### Тестирование
- [x] (P1) [2025-01-27] #9: Unit тесты для TweetsGateway — Написать unit тесты для новых методов TweetsGateway (мокирование Feign клиента, обработка ошибок).
  ...
  note: "Создан TweetsGatewayTest с тестами для методов likeTweet и retweetTweet. Покрыты успешные сценарии (с null comment и с comment), валидация null параметров (tweetId, request), обработка различных типов исключений (RuntimeException, IllegalArgumentException, generic exceptions). Используется мокирование TweetsApiClient через Mockito. Все тесты проходят успешно."
