...
/**
 * Response DTO for Tweet data (external API).
 * <p>
 * This record contains all relevant tweet data returned from the tweet-api service
 * via Feign Client.
 *
 ...
 * @param isDeleted flag indicating whether the tweet has been soft deleted
 * @param deletedAt timestamp when the tweet was soft deleted
 * @author geron
 * @version 1.0
 */
@Schema(
